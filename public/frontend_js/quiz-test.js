...
async function askQuestion(totalQuizQuestions, counter, fromBack) {
  ...
  if (type == 1) {
    ...
    const options = [
      ...ques.answers,
      { answer: "None of the above", id: "noneOfTheAbove" },
    ];
...
async function terminateQuiz() {
  try {
    const config = await getJson("api/terminate-config");
    const message = config.message;
    const countdown = config.countdown;

    // Create and display termination screen
    const terminationScreen = document.createElement("div");
    terminationScreen.style.position = "fixed";
    terminationScreen.style.top = "0";
    terminationScreen.style.left = "0";
    terminationScreen.style.width = "100%";
    terminationScreen.style.height = "100%";
    terminationScreen.style.backgroundColor = "#000000";
    terminationScreen.style.color = "white";
    terminationScreen.style.display = "flex";
    terminationScreen.style.justifyContent = "center";
    terminationScreen.style.alignItems = "center";
    terminationScreen.style.flexDirection = "column";
    terminationScreen.style.zIndex = "1000";
    document.body.appendChild(terminationScreen);

    const messageElement = document.createElement("h4");
    messageElement.textContent = message;
    messageElement.style.fontFamily = "Necto Mono";
    messageElement.style.fontSize = "24px";
    messageElement.style.fontWeight = "bold";
    terminationScreen.appendChild(messageElement);

    const terminationElement = document.createElement("h2");
    terminationElement.textContent = "Quiz will now be terminated";
    terminationElement.style.fontFamily = "Necto Mono";
    terminationElement.style.fontSize = "24px";
    terminationElement.style.fontWeight = "bold";
    terminationScreen.appendChild(terminationElement);

    const countdownElement = document.createElement("h5");
    countdownElement.style.fontFamily = "Necto Mono";
    countdownElement.style.fontSize = "20px";
    countdownElement.style.fontStyle = "italic";
    terminationScreen.appendChild(countdownElement);
...
function checkAllergie(event) {
  ...
  const allergies = ["Banana", "Olive", "Sunflowers"];
...
$(document).on("click", ".selectionBtn", checkAllergie);
